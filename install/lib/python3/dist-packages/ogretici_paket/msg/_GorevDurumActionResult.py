...
"""autogenerated by genpy from ogretici_paket/GorevDurumActionResult.msg. Do not edit."""
import codecs
import sys
...
class GorevDurumActionResult(genpy.Message):
  _md5sum = "e532786f68d71785b69dcf8e0740ffb8"
  _type = "ogretici_paket/GorevDurumActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ogretici_paket/GorevDurumResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GorevDurumActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = ogretici_paket.msg.GorevDurumResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ogretici_paket.msg.GorevDurumResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.sonuc = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.sonuc = str[start:end]
      return self
